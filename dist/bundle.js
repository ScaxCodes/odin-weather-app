...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,sBAAsB;EACtB,iBAAiB;EACjB,gBAAgB;EAChB,kEAAkE;EAClE;4DAC0D;AAC5D;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,yBAAyB;AAC3B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,6BAA6B;EAC7B,mBAAmB;EACnB,SAAS;EACT,YAAY;EACZ,yBAAyB;EACzB,aAAa;EACb,YAAY;EACZ,mBAAmB;AACrB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,SAAS;EACT,mBAAmB;EACnB,yBAAyB;EACzB,mBAAmB;EACnB,aAAa;AACf;;AAEA;;EAEE,iBAAiB;AACnB;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,aAAa;EACb,SAAS;AACX;;AAEA;EACE,kBAAkB;EAClB,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;EAClB,uBAAuB;AACzB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,yBAAyB;EACzB,mBAAmB;EACnB,aAAa;AACf;;AAEA;EACE,aAAa;EACb,SAAS;EACT,mBAAmB;AACrB;;AAEA;;EAEE,YAAY;EACZ,kBAAkB;AACpB;;AAEA;;EAEE,iBAAiB;AACnB;;AAEA;;EAEE,aAAa;AACf;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,mBAAmB;AACrB","sourcesContent":["* {\n  box-sizing: border-box;\n  font-size: 1.2rem;\n  line-height: 1.5;\n  /* https://css-tricks.com/snippets/css/system-font-stack/ below: */\n  font-family: system-ui, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif,\n    \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n}\n\nbody {\n  display: flex;\n  justify-content: center;\n  background-color: #f8e2e4;\n}\n\n.app-container {\n  display: flex;\n  flex-direction: column;\n  /* justify-content: center; */\n  align-items: center;\n  gap: 10px;\n  width: 550px;\n  background-color: #f1c5ca;\n  padding: 10px;\n  margin: 10px;\n  border-radius: 10px;\n}\n\n.current-container {\n  width: 500px;\n  display: flex;\n  gap: 20px;\n  align-items: center;\n  border: 1px solid #be2d3b;\n  border-radius: 10px;\n  padding: 10px;\n}\n\n.temp-toggle div,\n.temp-toggle button {\n  font-size: 0.7rem;\n}\n\n.temp-toggle div {\n  width: 70px;\n}\n\n.temp-toggle {\n  display: flex;\n  gap: 10px;\n}\n\nbutton {\n  border-radius: 5px;\n  border: 1px solid black;\n}\n\ninput {\n  border-radius: 5px;\n  border: 1px solid black;\n}\n\n.forecast {\n  width: 350px;\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  border: 1px solid #be2d3b;\n  border-radius: 10px;\n  padding: 10px;\n}\n\n.footer-container {\n  display: flex;\n  gap: 10px;\n  align-items: center;\n}\n\n.current-container .text,\n.footer-container .text {\n  width: 250px;\n  margin-right: auto;\n}\n\n.city,\n.date {\n  font-weight: bold;\n}\n\n.current-container,\n.forecast {\n  display: none;\n}\n\n.temp-f {\n  display: none;\n}\n\n.gif img {\n  border-radius: 10px;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
